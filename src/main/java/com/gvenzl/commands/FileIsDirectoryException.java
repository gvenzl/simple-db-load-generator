 ...
 * Since: October, 2018
 * Author: gvenzl
 * Name: FileIsDirectoryException.java
 * Description: Exception to handle cases where directories have been passed on.
 *
...
public class FileIsDirectoryException extends Exception {
    ...
    protected FileIsDirectoryException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
