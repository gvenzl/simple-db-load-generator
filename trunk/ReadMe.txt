...
Example: java -jar SimpleLoadGenerator.jar -user scott -password tiger -host localhost -port 1521 -sid MYDB -databaseType oracle -ignoreErrors -sqlfile ./SQLs.txt -sessions 10 -ignoreErrors